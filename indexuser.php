...
$conn = mysqli_connect("localhost","root","","restaurant");
    $mail = $_POST['mail'];
		$pass = $_POST['password'];
		$q = mysqli_query($conn,"SELECT * FROM user where email = '$mail' and password = '$pass'");
		$k = mysqli_fetch_array($q);
		if(mysqli_num_rows($q) == 0){
            
  	echo "<script> alert('No User Found'); ";
  	echo "window.location='user/login.html';</script>";
    ...
    <nav  id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <li class="nav-item active">
              ...
              <a class="nav-link" href="#nav-bar"><?php echo "logged in as: "."<u>".$k["name"]."</u>"; ?><span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item">
              <a class="nav-link" href="user/login.html">Log Out</a>
            </li>
        ...
        <div class="col-md-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div>
              	<div class="mapouter"><div class="gmap_canvas"><iframe width="600" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=kairouan%20brija&t=k&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                  <a href="https://www.whatismyip-address.com/divi-discount/"></a><br><style>.mapouter{position:relative;text-align:right;height:500px;width:600px;}</style><a href="https://www.embedgooglemap.net">embedded maps google</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:600px;}</style></div></div>
            ...
            <div class="col-sm">
              <div class="card" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                  <li class="list-group-item">Try It With UsWe Are The Best Service
<span class="badge badge-pill badge-primary"> We Are The Best Service</span></li>
        ...
        <div class="container">
          ...
          <form id="form"  method="post" action="php/insert.php">
            ...
            <div class="form-group">
              ...
              <textarea placeholder="Enter your comment or suggestion here..." class="form-control" id="comment" rows="1" name="sug"></textarea>
            </div>
...
<input type="text" value=<?php echo $mail; ?> hidden name="mail" >
...
<!-- End This -->
            ...
            <input id="submit" type="submit" class="btn btn-primary btn-block"  value="Order Now" name="order" >
      <!-- Dev. by munkgorn -->
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <div class="col item social"><a href="https://www.facebook.com/ElBrija.laClasse/"><i class="icon ion-social-facebook"></i></a> <h6> Facebook  </h6></div>
                </div>
